<template>
	<view>
		<view class="cu-modal drawer-modal justify-end" :class="show ? 'show' : ''" @tap="hideModal">
			<view class="cu-dialog bg-gray text-black basis-lg padding" @tap.stop="" style="background-color: #D2F1F0; height: 100%;background-size:100% 100%;" :style="[{ top: CustomBar + 'px', height: 'calc(100vh - ' + CustomBar + 'px)' }]">
